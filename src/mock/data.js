...
export const projectsData = [
  {
    ...
    info: 'Fullstack web for video gamers find friends or other gamers to play together, team of 3 in created a full-stack web used html, css, Javascript, node.js, Auth0,socket.Io, rapid api, mongodb,jquery',
    info2: '',
  ...
  },
  {
    ...
    img: 'trace.jpg',
    title: 'Trace',
    info: 'Web app that uses passport to authenticate and login and stores all the tracking data Team of four created tracking website that is one stop for all the carriers Technology used : HTML CSS JavaScript, Bulma, Passport, mysql',
    info2: '',
  ...
  },
  {
    ...
    info: 'Web app that allows users to search a book to see if there is a movie version with details about it and vice versa via google books API and IMDB API Technology used : Html, CSS, Javascript, ajax, jQuery, animate, google books api, imdb api',
    info2: '',
